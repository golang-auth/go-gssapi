...
func TestNtOid(t *testing.T) {
	...
	assert.PanicsWithError("bad name type", func() { badNt.Oid() })
}
...
func TestNtOidString(t *testing.T) {
	...
	badNt := GssNameType(100)
	assert.PanicsWithError("bad name type", func() { badNt.OidString() })
}
...
func TestNtString(t *testing.T) {
	...
	badNt := GssNameType(100)
	assert.PanicsWithError("bad name type", func() { badNt.String() })
}
