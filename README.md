...
go-gssapi is not yet considered to be production ready, and the interface is not yet considered stable.  A new v1 branch will be created after which we will follow normal [semantic versioning conventions](https://golang.org/ref/mod#versions).
