...
// WithChannelBindingType sets the channel binding type for the Handler
...
// ServerWithStashConn returns a new http.Server with a ConnContext function that
// stashes the net.Conn in the connection's context.  The original ConnContext function
// is called if it is not nil.
